...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 11, 2023 at 03:23 PM
...
CREATE TABLE `mess` (
  ...
  `messaddress` varchar(200) COLLATE utf8_bin NOT NULL,
...
INSERT INTO `mess` (`messid`, `messname`, `ownername`, `messemail`, `messmobile`, `messpassword`, `messaddress`, `messphoto`) VALUES
(5, 'Chintamani', 'Chintaman', 'chinta@gmail.com', '8574635241', 'Zxcvbnm@123', 'Sinhgad College , Pune', '9.jpg'),
(6, 'Gharchi Athavan', 'S. K. Patil', 'gharchiathvan@gmail.com', '9874563214', 'Asdfghjkl@123', 'Sinhgad Institute of Management, Pune', '5.jpg'),
(7, 'Rohini Mess', 'Aaji', 'rohini@gmail.com', '9876543210', 'Qwerty@123', 'Stanza Living , Pune', '4.jpg'),
(8, 'Umaya Mess', 'Gujarati', 'umaya@gmail.com', '9876543210', 'Umaya@123', 'Sinhgad Institute of Management, Pune', 'umaya mess.jpeg'),
(9, 'ganesh', 'ganesh', 'gana@gmail.com', '6584451514', 'Gana@2000', 'pune', 'Screenshot (83).png');
...
--
ALTER TABLE `menu`
  MODIFY `mno` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=27;

--
-- AUTO_INCREMENT for table `mess`
--
ALTER TABLE `mess`
  MODIFY `messid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
